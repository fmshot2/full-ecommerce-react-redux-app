            ...
            <div className="col-12 col-sm-6 col-md col-lg-4 col-xl-2">
              <div className="single_footer_area mb-100">
                ...
                <ul className="footer_widget_menu">
                  ...
                  <li><a href="#"><i className="icofont-rounded-right"></i> Free Shipping Policy</a></li>
            ...
            <div className="col-12 col-sm-6 col-md col-lg-4 col-xl-2">
              <div className="single_footer_area mb-100">
                ...
                <ul className="footer_widget_menu">
                  ...
                  <li><a href="#"><i className="icofont-rounded-right"></i> Terms &amp; Conditions</a></li>
              ...
              <div className="single_footer_area mb-50">
                ...
                <div className="subscribtion_form">
                  <form action="#" method="post">
                    ...
                    <button type="submit" className="submit"><i className="icofont-long-arrow-right"></i></button>
                  </form>
                </div>
              </div>
              <div className="single_footer_area mb-100">
